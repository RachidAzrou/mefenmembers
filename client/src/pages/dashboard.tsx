                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-lg bg-gray-50">
                    <div className="bg-purple-100 p-3 rounded-full">
                      ...
                      >
                        <path d="M10 14a3.5 3.5 0 0 0 5 0l4-4.5a3.5 3.5 0 1 0-5-5L9.5 9" />
                        <path d="M9.5 14a3.5 3.5 0 0 1-5 0l-4-4.5a3.5 3.5 0 1 1 5-5L10 9" />
                        <path d="M7.739 17.682C7.273 19.415 6.5 21 5.5 21c-2.485 0-4.5-4.477-4.5-10S3.015 1 5.5 1c.893 0 1.65 1.092 2.205 2.77" />
                        <path d="M16.261 17.682C16.727 19.415 17.5 21 18.5 21c2.485 0 4.5-4.477 4.5-10S20.985 1 18.5 1c-.893 0-1.65 1.092-2.205 2.77" />
